...
if (empty($config['client_id']) || empty($config['client_secret'])) {
    ...
    if (empty($config['client_id_alt']) || empty($config['client_secret_alt'])) {
        throw new Exception('We could not locate the alternate client id or client secret in "' . __DIR__ . '/config.json". Please create one, and reference config.json.example');
    }
