...
//                print("file_name :: "+file_name!)
                ...
                let arguments = ["-f", "concat", "-safe", "0", "-i", url.path, "-y", "-codec", "copy", outputFile];
    ...
    func addVideoToVimeo(outputFile:String, file_name:String, vttDataArray:Array<VTTData>) -> Void {
        print("we're in the second function")
...
//        print("creating csv for "+contentArray.count.description+" items");
        ...
        let file = AlbumID!+"_"+groupName.stringValue+".csv"
        var text = "AlbumID,"+AlbumID!+",Album Name,"+groupName.stringValue+"\n"
